...
if response2 == 1:
    out = "--------注册未开户banner：Success-----" 
    output2 = out
else:
    out = "--------注册未开户banner：Fail--------"
    output2 = out
...
if response3 == 1:
    out = "--------开户未激活banner：Success------" 
    output3 = out
else:
    out = "--------开户未激活banner：Fail---------"
    output3 = out
